...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.ActivityEventResponse"
                            }
                        }
                    },
                    "401": {
        ...
        "/projects/{key}/issues": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by type (task|story|bug|epic)",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/projects/{key}/sprints/{id}/issues": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "dto.BoardResponse": {
            ...
            "properties": {
                "columns": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.BoardColumn"
                    }
                }
            }
        },
        ...
        "dto.UpdateIssueRequest": {
            ...
            "properties": {
                ...
                "sprint_id": {
                    "description": "SprintID assigns the issue to a sprint. Send 0 to move the issue back to the backlog.",
                    "type": "integer"
                },
                "status": {
                    "type": "string",
